...
class Definitions:
    ...
    atomics = {'Byte' : numpy.dtype(numpy.byte),
               'Int16' : numpy.dtype(numpy.int32), # Int16 always seems to map to int32 in practice
    ...
    constructors = ['Dataset','Array','Structure','Grid','Sequence','Maps'] # NB can be in all upper case as well
